...
export class DropdownSelectComponent implements OnInit{
  ...
  buttonPressed(elem: MouseEvent|null, selectName: string | undefined){
    ...
    const inputValue=document.querySelector(selectQuery+ " .dropdown-input-value") as HTMLInputElement;
    const inputDisplay=  document.querySelector(selectQuery+ " .dropdown-input-display") as HTMLInputElement;
  ...
  ngOnInit(): void {
    ...
    const dropdown = document.querySelector(selectQuery+" div.dropdown") as HTMLElement;
  ...
  @Input('displayValues') displayValues: Array<string> | undefined;
  //An array of strings which represents the value of each option, required
  @Input('actualValues') actualValues!: Array<string>;
  //Value that you wish to be automatically selected, not required
  @Input('selectedValue') selectedValue: string | undefined;
  ...
  @Input('displayedValue') displayedValue: string | undefined;
